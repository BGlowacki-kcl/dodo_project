                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {editableUser.education && editableUser.education.map((edu, index) => (
                            <div key={index} className="p-4 border rounded-lg mb-4 relative">
                                ...
                                <p className="text-black"><strong>Start Date:</strong> {isEditing.education ? <input type="date" name={`education.${index}.startDate`} value={edu.startDate} onChange={handleInputChange} className="border p-1" /> : formatDate(edu.startDate)}</p>
                                <p className="text-black"><strong>End Date:</strong> {isEditing.education ? <input type="date" name={`education.${index}.endDate`} value={edu.endDate} onChange={handleInputChange} className="border p-1" /> : formatDate(edu.endDate)}</p>
                                {isEditing.education && (
                            ...
                            <div key={index} className="mb-4 p-4 border rounded-lg relative">
                                <div className="flex flex-col md:flex-row justify-between">
                                    <div className="flex-1">
                                        ...
                                        <p className="text-black"><strong>Start Date:</strong> {isEditing.experience ? <input type="date" name={`experience.${index}.startDate`} value={exp.startDate} onChange={handleInputChange} className="border p-1" /> : formatDate(exp.startDate)}</p>
                                        <p className="text-black"><strong>End Date:</strong> {isEditing.experience ? <input type="date" name={`experience.${index}.endDate`} value={exp.endDate} onChange={handleInputChange} className="border p-1" /> : formatDate(exp.endDate)}</p>
                                    </div>
